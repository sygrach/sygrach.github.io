      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
          ...
          <ul className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
            <Feature name='Выделение отдельных инструментов' icon={Square3Stack3DIcon} />
            <Feature name='Удаление выбранного инструмента' icon={MinusCircleIcon}  />
          </ul>
        </div>
        <div className="mx-auto mt-16 max-w-2xl sm:mt-20 lg:mt-24 lg:max-w-4xl">
          <h3 className='max-w-xl text-xl font-semibold mb-8'>Будет доступно в следующей версии:</h3>
          <ul className="grid max-w-xl grid-cols-1 gap-x-8 gap-y-10 lg:max-w-none lg:grid-cols-2 lg:gap-y-16">
            <Feature name='Дабовление метронома' icon={ClockIcon} />
            <Feature name='Изменение тональности' icon={AdjustmentsVerticalIcon} />
          </ul>
        </div>
      </div>
    </div>
